...
public class SendMail {
 ...
 private String user = "nullpointerx@163.com"; // 用户名
 private String pwd = "zhuweiqiang"; // 密码
 private String from = "nullpointerx@163.com"; // 发件人地址
 ...
 public static void main(String[] args) {
  ...
  // 设置发件人地址、收件人地址和邮件标题
  cn.setAddress("nullpointerx@163.com", "唉"); 
  cn.send("<a href='#'>~~~</a><p>段落！</p>");
