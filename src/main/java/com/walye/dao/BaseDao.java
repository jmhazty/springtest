...
public interface BaseDao<E, PK extends Serializable> {
    ...
    /**
     * 通过多个属性查找，并分页， 属性名称数组和属性值数组的序列要对应,并根据字段排序
     * 
     * @param propertyNames 属性名称数组
     * @param values 属性值数组
     * @param page 页码
     * @param pageSize 每页内容条数
     * @param propertyName排序字段
     * @return 分页后的结果
     */
    List<E> pageByPropertysAndOrder(String[] propertyNames, Object[] values, int page, int pageSize,String propertyName, boolean isSequence);
    
    
    /**
     * 通过单个属性查找，并分页， 属性名称数组和属性值数组的序列要对应,并根据字段排序
     * 
     * @param propertyNames 属性名称数组
     * @param values 属性值数组
     * @param page 页码
     ...
     * @return 分页后的结果
     */
    List<E> pageByPropertyAndOrder(String propertyName, Object values, int page, int pageSize,String orderPropertyName, boolean isSequence);
     ...
     * @return 分页后的结果
     */
    List<E> pageAndOrder( int page, int pageSize,String propertyName, boolean isSequence);
     ...
     * @return
     */
    List<E> findByHql(String hql,String... params);
    /**
     * 根据sql语句查询
     * @param sql
     * @param params
     * @return
     */
    List<E> findBySql(String sql,String... params);
